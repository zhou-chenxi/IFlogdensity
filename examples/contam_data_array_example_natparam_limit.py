...
if __name__ == '__main__':
    ...
    for contam_data in contam_data_array:
        ...
        ifun_natparam_file_name = f'/contam_data={contam_data_array[i]}-IF-natparam-newdata.npy'
        ifun_natparam = ifun.eval_IF_natparam(new_data=new_data)

        ifun_natparamlimit_file_name = f'/contam_data={contam_data_array[i]}-IF-natparam-limit-newdata.npy'
